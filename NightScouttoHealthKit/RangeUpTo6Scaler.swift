...
/// Scaler for RangeUpTo6 TCN model - handles input normalization
/// This class provides standardization (z-score normalization) for the 8-feature input data
class RangeUpTo6Scaler {
    
    // Scaler parameters loaded from rangeupto6_scaler.npz
    private let mean: [Double] = [
        5.62222389e-05,   // Feature 0
        7.12211637e+00,   // Feature 1  
        3.10211675e+01,   // Feature 2
        9.51059140e+01,   // Feature 3
        2.85720664e-02,   // Feature 4
        -2.78613377e-01,  // Feature 5
        6.23177127e-04,   // Feature 6
        8.46914491e+00    // Feature 7
    ]
    
    private let scale: [Double] = [
        0.13327915,       // Feature 0
        2.47138263,       // Feature 1
        19.76961375,      // Feature 2
        18.52669666,      // Feature 3
        0.75100331,       // Feature 4
        0.59795673,       // Feature 5
        3.02853672,       // Feature 6
        4.378372          // Feature 7
    ]
...
extension RangeUpTo6Scaler {
    ...
    static func exampleUsage() {
        ...
        do {
            ...
            // let model = try RangeUpTo6TCN(configuration: MLModelConfiguration())
            // let prediction = try model.prediction(from: modelInput)
            
            print("✅ Data successfully prepared for RangeUpTo6 TCN model")
        } catch {
